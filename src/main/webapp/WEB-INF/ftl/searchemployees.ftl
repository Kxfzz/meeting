...
<div class="container">
    ...
    <div class="page-body">
        ...
        <div class="page-content">
            ...
            <form action="/admin/searchemployees" method="get" class="form-inline">
                <fieldset>
                    <legend>搜索会议</legend>
                    <table class="formtable">
                        <tr>
                            <td>姓名：</td>
                            <td>
                                <input name="employeeName" class="form-control" type="text" id="employeename"
                                       value="<#if employee??>${employee.employeeName!''}</#if>" maxlength="20"/>
                            </td>
                            <td>账号名：</td>
                            <td>
                                <input name="username" type="text" class="form-control" id="accountname"
                        ...
                        <tr>
                            <td colspan="6" class="command">
                                <input type="submit" class="clickbutton btn btn-info" value="查询"/>
            ...
            <div>
                ...
                <div class="pager-header">
                    ...
                    <div class="header-nav">
                        <a type="button" class="clickbutton btn btn-default"
                ...
                <#if emps??>
                    <#list emps as emp>
                        <tr>
                            ...
                            <td>${emp.email}</td>
                            <td>
                                <a class="clickbutton btn btn-danger btn-xs" href="/admin/updateemp?id=${emp.employeeId}">关闭账号</a>
                            </td>
                        </tr>
                    </#list>
                </#if>
