                ...
                <fieldset>
                    ...
                    <table class="formtable">
                        <tr>
                            ...
                            <td>预定者姓名：</td>
                            <td>
                                <input class="form-control" type="text" name="reservationistname"
                                       id="reservationistname"
                                       value="<#if meetingDTO??>${meetingDTO.reservationistname!''}</#if>"
                                       maxlength="20"/>
                            </td>
                        </tr>
                        <tr>
                            <td>预定日期：</td>
                            <td colspan="6">
                                在&nbsp;<input class="Wdate" type="text" name="reservationtime"
                                              id="reservationtime"
                        ...
                        <tr>
                            <td colspan="6" class="command">
                                <input type="submit" class="clickbutton btn btn-primary" value="查询"/>
            ...
            <div>
                ...
                <div class="pager-header">
                    ...
                    <div class="header-nav">
                        <a type="button" class="clickbutton btn btn-primary" href="/searchmeetings?&page=1">首页</a>
                        <a type="button" class="clickbutton btn btn-primary"
                           href="/searchmeetings?page=${page-1}">上页</a>
                        <a type="button" class="clickbutton btn btn-primary"
                           href="/searchmeetings?page=${page+1}">下页</a>
                        <a type="button" class="clickbutton btn btn-primary"
                           href="/searchmeetings?page=${pagenum}">末页</a>
                        <form action="" style="display: inline" method="get" class="form-inline">
                            跳到第<input name="page" type="text" id="pagenum" class="nav-number"/>页
                            <input type="submit" class="clickbutton btn btn-success" value="跳转"/>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <#if meetings??>
                    <#list meetings as m>
                        <tr>
                            ...
                            <td>
                                <a class="clickbutton btn btn-default btn-xs"
                                   href="/meetingdetails?meetingid=${m.meetingid}">查看详情</a>
                            </td>
                        </tr>
                    </#list>
                </#if>
